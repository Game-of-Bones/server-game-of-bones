...
const seedFossils = async () => {
    try {
        ...
        // Crear fósiles
        const createdFossils = await GobModelPost_1.default.bulkCreate(fossilsData);
...
exports.seedFossils = seedFossils;
/**
 * Eliminar todos los fósiles (para testing)
 */
const clearFossils = async () => {
    try {
        await GobModelPost_1.default.destroy({ where: {}, force: true });
...
exports.clearFossils = clearFossils;
exports.default = exports.seedFossils;
//# sourceMappingURL=02-fossils.js.map